...
**graph view** is useful to explore notes and their connections but I rarely find myself looking at it beyond the glamour of seeing all my notes visually. you can use it to see how different notes may end up connected by following the jumps in nodes. 

here is a great guide for learning how to jump into obsidian and avoid the stress of trying to build "the perfect vault" — it doesnt exist. you'll learn what works for you with time. the most important thing is to start writing.

![obsidian guide](https://www.youtube.com/watch?v=hSTy_BInQs8)
## plugins I use
most of these are just for personalizing your vault. as a grad student, the most important plugin is zotero integration (see [[setting up zotero integration]]). The rest I like because they make my life a bit easier and make my vault more enjoyable to work in. Here are the [[obsidian plugins that i use]]. 
## workflow for daily notes
I have a daily note template with date as the title and notes section with different topics divided by subheaders. 
